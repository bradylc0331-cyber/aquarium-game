...
| 檔案 | 內容 | 備註 |
| --- | --- | --- |
| `plate1-gauge.3mf` | 試裝規 ×1 | **先印這個**，約 10 分鐘 |
| `plate2-foot-knobs.3mf` | 底座 ×1、旋鈕 ×4 | 最大件 |
...
2. **接頭**：把 M4 螺帽壓進 `plug` 兩端的六角袋。接頭一插進立柱，螺帽就掉不出來了。
