...
(function (root) {
  ...
  // 八隻魚沿河散開。尺寸刻意全部相同——大小差異一律交給景深縮放，
  // 若這裡再各給一個尺寸，就會跟景深疊加，出現「上游的魚比下游大」的怪事。
  // 變化改由速度、擺尾相位、朝向、透明度提供。
  const RIVER_FISH_LAYOUT = [
    // [progress, speed, direction, phase, width, height, opacity]
    [0.08, 0.017, 1, 0.4, 42, 21, 0.56],
    [0.20, 0.022, -1, 1.1, 42, 21, 0.60],
    [0.33, 0.014, 1, 2.0, 42, 21, 0.58],
    [0.45, 0.025, -1, 2.8, 42, 21, 0.64],
    [0.57, 0.016, 1, 3.6, 42, 21, 0.62],
    [0.69, 0.023, -1, 4.3, 42, 21, 0.66],
    [0.81, 0.019, 1, 5.0, 42, 21, 0.68],
    [0.92, 0.021, -1, 5.8, 42, 21, 0.70],
  ];
